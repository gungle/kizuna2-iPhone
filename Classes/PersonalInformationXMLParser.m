//
//  PersonalInformationXMLParser.m
//  Scope2
//
...
#import "PersonalInformationXMLParser.h"
#import "UPersonalMng.h"

//static PersonalInformationXMLParser *sharedPersonalInformationXMLParser;


@implementation PersonalInformationXMLParser

@synthesize delegate;
@synthesize personalMng;

+ (PersonalInformationXMLParser *)sharedXMLParser {
//	if (!sharedPersonalInformationXMLParser) {
//		NSLog(@"----- >>>>>>>>>>>>>> PersonalXMLParser");
//		sharedPersonalInformationXMLParser = [[PersonalInformationXMLParser alloc] init];
//	}
//	return sharedPersonalInformationXMLParser;
	return nil;
}
...
- (void)dealloc {
	NSLog(@"----->>>> dealloc");
//	sharedPersonalInformationXMLParser = nil;
//	for (UPersonalMng *mng in items) {
//		[mng release];
//		NSLog(@"----->>>> ");
//		mng = nil;
//	}
